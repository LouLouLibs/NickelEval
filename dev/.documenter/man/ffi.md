...
# FFI Mode (High Performance) {#FFI-Mode-High-Performance}
...
## Checking FFI Availability {#Checking-FFI-Availability}
...
## Using FFI Evaluation {#Using-FFI-Evaluation}
...
## Building the FFI Library {#Building-the-FFI-Library}
...
### &quot;FFI not available&quot; Error {#"FFI-not-available"-Error}
